...
public:
	...
	virtual std::uint16_t get_miner_legacy_listen_port() const = 0;
	...
	virtual bool get_legacy_mode() const = 0;	
	virtual std::string const& get_whitefire_substitute_address() const = 0;
};
