...
public:
    ...
    Rest_controller(chrono::Timer_factory::Sptr timer_factory,
    ...
    : Base_controller(std::move(timer_factory), std::move(data_reader), std::move(pool_api_data_exchange), std::move(config_api), std::move(objectMapper))
    {}
