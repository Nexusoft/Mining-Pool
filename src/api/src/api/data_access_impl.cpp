...
{
	m_create_tables_cmd = std::any_cast<std::shared_ptr<Command<std::vector<std::string>, sqlite3_stmt*>>>(
		m_command_factory->create_command(Type::create_db_schema));
	m_get_banned_ip_cmd = std::any_cast<std::shared_ptr<Command<std::vector<std::string>, sqlite3_stmt*>>>(
