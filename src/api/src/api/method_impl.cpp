...
Method_meta_infos::Method_meta_infos(std::shared_ptr<spdlog::logger> logger, Data_access::Sptr data_access)
...
Method_latest_blocks::Method_latest_blocks(std::shared_ptr<spdlog::logger> logger, Data_access::Sptr data_access)
    : m_logger{ std::move(logger) }
    , m_data_access{ std::move(data_access) }
{
}
...
Methods_factory_impl::Methods_factory_impl(std::shared_ptr<spdlog::logger> logger, Data_access::Sptr data_access)
	: m_logger{ std::move(logger) }
    , m_data_access{std::move(data_access)}
{
}
